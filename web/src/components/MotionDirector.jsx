          ...
          trigger={<>
            ...
            <span aria-hidden="true"
              ...
              {activeEngine?.upscale_2x && (
                <Row label={<><Chip>2×</Chip> upscale <InfoTip size={11} text={"Native 2x: after sampling, H3 runs a second pass over its own latent at twice the canvas, so detail is generated by the video model itself rather than guessed from finished pixels. Costs ~3x the render near the card's ceiling - even a 2 s clip takes a while. Runs in short time chunks so long clips stay clean."} /></>}
                  hint={upscale
